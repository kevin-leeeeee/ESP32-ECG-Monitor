...
2. **AD8232 心電圖 (ECG) 整合訊號調理模組**：專為生物電訊號設計的類比前端晶片，整合了運算放大器與低通/高通濾波電路，能有效放大心電微弱訊號並過濾直流偏置。
3. **Ag/AgCl 醫療級一次性電極貼片與電極扣導線**：負責從體表傳導微弱的毫伏特 (mV) 級 ECG 訊號。
4. **行動電源 (Power Bank - 乾淨直流電源)**：⚠️ **極為關鍵的硬體推薦！**
